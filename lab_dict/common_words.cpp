...
{
  for (vector<map<string, unsigned int>>::iterator file = file_word_maps.begin() ; file != file_word_maps.end(); file++) {
    for (map<string, unsigned int>::iterator word = (*file).begin() ; word != (*file).end(); word++) {
